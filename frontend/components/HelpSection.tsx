    ...
    <div className="mt-8 border-t border-slate-200 pt-6">
      ...
      {isOpen && (
        <div className="mt-4 bg-slate-50 p-6 rounded-3xl text-[13px] text-slate-600 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300 border border-slate-100">
          <p>
            <strong className="text-slate-900 uppercase tracking-tighter">Unified Ledger Accuracy:</strong> Balances are derived by evaluating every transaction since account inception.
          </p>
          <p>
          ...
          <p>
            <strong className="text-slate-900 uppercase tracking-tighter">Immutable Governance:</strong> Transactions cannot be deleted or edited.
          </p>
        </div>
      )}
    </div>
